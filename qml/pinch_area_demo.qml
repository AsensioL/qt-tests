...
ApplicationWindow {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            //    //onTouchUpdated: console.log("onTouchUpdated")
            //    onTouchUpdated:      (touch) => console.log(`onUpdated ${touch.length}`)
            //}
            ...
            //        //console.log(`---------------------`)
            //        console.log(`startCenter: ${pinch.startCenter} center: ${pinch.center} scale: ${pinch.scale}`)
            //        }
